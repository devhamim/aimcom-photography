...
<div class="content">
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        <div>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#addgallery"> Add Category
            </button>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="responsive-data-table" class="table">
                            ...
                            <tbody>
                                @foreach ($blogcategory as $gallery)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group mb-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form action="{{ route('storiescategory.destroy',  $gallery->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    <div class="modal fade modal-add-contact" id="editgallery{{ $gallery->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <form action="{{ route('storiescategory.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
    ...
    <div class="modal fade modal-add-contact" id="addgallery" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('storiescategory.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header px-4">
