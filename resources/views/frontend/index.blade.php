...
@section('content')
            ...
            <div id="rev_slider_24_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;"
                ...
                <ul>
                    ...
                    <li data-index="rs-67" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-thumb="{{ asset('frontend') }}/assets/img/revslider/3rdRev/woman2-100x50.jpg" data-rotate="0"
                        data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                        data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                        data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('frontend') }}/assets/img/revslider/3rdRev/woman2.jpg" alt=""
                            data-bgposition="center center" data-kenburns="on" data-duration="5000"
                            data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0"
                            data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0"
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-67-layer-9"
                            ...
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250" data-slicey_blurstart="0"
                    ...
                    <li data-index="rs-66" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600"
                        data-thumb="{{ asset('frontend') }}/assets/img/revslider/3rdRev/deskbg-100x50.jpg" data-rotate="0"
                        data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                        data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                        data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('frontend') }}/assets/img/revslider/3rdRev/deskbg.jpg" alt=""
                            data-bgposition="center center" data-kenburns="on" data-duration="5000"
                            data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0"
                            data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0"
                            data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 18 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-9"
                            data-x="['center','center','center','center']" data-hoffset="['-112','-43','-81','44']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-219','-184','-185','182']"
                            data-width="['250','250','150','150']" data-height="['150','150','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                            ...
                            style="z-index: 5;background-color:rgba(0, 0, 0, 0.5);"> </div>
                        <!-- LAYER NR. 19 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-10"
                            data-x="['center','center','center','center']" data-hoffset="['151','228','224','117']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-212','-159','71','-222']"
                            data-width="['150','150','100','100']" data-height="['200','150','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                            ...
                            style="z-index: 6;background-color:rgba(0, 0, 0, 0.5);"> </div>
                        <!-- LAYER NR. 20 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-29"
                            data-x="['center','center','center','center']" data-hoffset="['339','-442','104','-159']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['2','165','-172','219']"
                            data-width="['250','250','150','150']" data-height="['150','150','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 21 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-12"
                            data-x="['center','center','center','center']" data-hoffset="['162','216','-239','193']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['195','245','6','146']"
                            data-width="['250','250','100','100']" data-height="150" data-whitespace="nowrap"
                            data-type="shape" data-slicey_offset="250" data-slicey_blurstart="0"
                        ...
                        <!-- LAYER NR. 22 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-34"
                            data-x="['center','center','center','center']" data-hoffset="['-186','-119','273','-223']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['269','217','-121','69']"
                            data-width="['300','300','150','150']" data-height="['200','200','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 23 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-11"
                            data-x="['center','center','center','center']" data-hoffset="['-325','292','162','-34']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['3','55','-275','-174']"
                            data-width="150" data-height="['250','150','50','50']" data-whitespace="nowrap"
                            data-type="shape" data-slicey_offset="250" data-slicey_blurstart="0"
                        ...
                        <!-- LAYER NR. 24 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-27"
                            data-x="['center','center','center','center']" data-hoffset="['-429','523','-190','-306']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-327','173','181','480']"
                            data-width="['250','250','150','150']" data-height="['300','300','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 25 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-28"
                            data-x="['center','center','center','center']" data-hoffset="['422','-409','208','225']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-245','-72','294','-14']"
                            data-width="['300','300','150','150']" data-height="['250','250','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 26 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-30"
                            data-x="['center','center','center','center']" data-hoffset="['549','-445','28','58']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['236','400','316','287']"
                            data-width="['300','300','150','200']" data-height="['250','250','150','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 27 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-31"
                            data-x="['center','center','center','center']" data-hoffset="['-522','492','-151','262']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['339','-180','330','-141']"
                            data-width="['300','300','150','150']" data-height="['250','250','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 28 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-32"
                            data-x="['center','center','center','center']" data-hoffset="['-588','-375','-253','-207']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['72','-328','-172','-111']"
                            data-width="['300','300','150','150']" data-height="['200','200','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 29 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-33"
                            data-x="['center','center','center','center']" data-hoffset="['-37','73','-76','-100']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-401','-340','-293','-246']"
                            data-width="['450','400','250','250']" data-height="['100','100','50','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 30 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-66-layer-35"
                            data-x="['center','center','center','center']" data-hoffset="['186','38','116','17']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['363','402','190','395']"
                            data-width="['350','400','250','250']" data-height="['100','100','50','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 31 -->
                        <div class="tp-caption tp-shape tp-shapewrapper " id="slide-66-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-width="full" data-height="full" data-whitespace="nowrap" data-type="shape"
                            data-basealign="slide" data-responsive_offset="off" data-responsive="off"
                    ...
                    <li data-index="rs-68" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600"
                        data-thumb="{{ asset('frontend') }}/assets/img/revslider/3rdRev/reachout_bg-100x50.jpg"
                        data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                        data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                        data-param9="" data-param10="" data-description=""
                        data-slicey_shadow="0px 0px 0px 0px transparent">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('frontend') }}/assets/img/revslider/3rdRev/reachout_bg.jpg" alt=""
                            data-bgposition="center center" data-kenburns="on" data-duration="5000"
                            data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="150" data-rotatestart="0"
                            data-rotateend="0" data-blurstart="20" data-blurend="0" data-offsetstart="0 0"
                            data-offsetend="0 0" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 35 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-9"
                            data-x="['center','center','center','center']" data-hoffset="['-112','-43','-81','44']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-219','-184','-185','182']"
                            data-width="['250','250','150','150']" data-height="['150','150','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 36 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-10"
                            data-x="['center','center','center','center']" data-hoffset="['151','228','224','117']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-212','-159','71','-222']"
                            data-width="['150','150','100','100']" data-height="['200','150','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 37 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-29"
                            data-x="['center','center','center','center']" data-hoffset="['339','-442','104','-159']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['2','165','-172','219']"
                            data-width="['250','250','150','150']" data-height="['150','150','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 38 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-12"
                            data-x="['center','center','center','center']" data-hoffset="['162','216','-239','193']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['195','245','6','146']"
                            data-width="['250','250','100','100']" data-height="150" data-whitespace="nowrap"
                            data-type="shape" data-slicey_offset="250" data-slicey_blurstart="0"
                        ...
                        <!-- LAYER NR. 39 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-34"
                            data-x="['center','center','center','center']" data-hoffset="['-186','-119','273','-223']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['269','217','-121','69']"
                            data-width="['300','300','150','150']" data-height="['200','200','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 40 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-11"
                            data-x="['center','center','center','center']" data-hoffset="['-325','292','162','-34']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['3','55','-275','-174']"
                            data-width="150" data-height="['250','150','50','50']" data-whitespace="nowrap"
                            data-type="shape" data-slicey_offset="250" data-slicey_blurstart="0"
                        ...
                        <!-- LAYER NR. 41 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-27"
                            data-x="['center','center','center','center']" data-hoffset="['-429','523','-190','-306']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-327','173','181','480']"
                            data-width="['250','250','150','150']" data-height="['300','300','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 42 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-28"
                            data-x="['center','center','center','center']" data-hoffset="['422','-409','208','225']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-245','-72','294','-14']"
                            data-width="['300','300','150','150']" data-height="['250','250','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 43 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-30"
                            data-x="['center','center','center','center']" data-hoffset="['549','-445','28','58']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['236','400','316','287']"
                            data-width="['300','300','150','200']" data-height="['250','250','150','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 44 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-31"
                            data-x="['center','center','center','center']" data-hoffset="['-522','492','-151','262']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['339','-180','330','-141']"
                            data-width="['300','300','150','150']" data-height="['250','250','100','100']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 45 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-32"
                            data-x="['center','center','center','center']" data-hoffset="['-588','-375','-253','-207']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['72','-328','-172','-111']"
                            data-width="['300','300','150','150']" data-height="['200','200','150','150']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="300"
                        ...
                        <!-- LAYER NR. 46 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-33"
                            data-x="['center','center','center','center']" data-hoffset="['-37','73','-76','-100']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['-401','-340','-293','-246']"
                            data-width="['450','400','250','250']" data-height="['100','100','50','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 47 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-slicey  tp-resizeme" id="slide-68-layer-35"
                            data-x="['center','center','center','center']" data-hoffset="['186','38','116','17']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['363','402','190','395']"
                            data-width="['350','400','250','250']" data-height="['100','100','50','50']"
                            data-whitespace="nowrap" data-type="shape" data-slicey_offset="250"
                        ...
                        <!-- LAYER NR. 48 -->
                        <div class="tp-caption tp-shape tp-shapewrapper " id="slide-68-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-width="full" data-height="full" data-whitespace="nowrap" data-type="shape"
                            data-basealign="slide" data-responsive_offset="off" data-responsive="off"
    ...
    <section class="service2-area">
        <div class="container">
            <div class="row">
                <div class="col-md-4 wow fadeIn" data-wow-delay=".99s"
                    style="visibility: visible; animation-delay: 0.99s; animation-name: fadeIn;">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-img a3-img">
                        <img src="{{ asset('frontend') }}/assets/img/section-img/about-2-1.jpg" alt=""
                            class="a3img-1 wow fadeInLeft" data-wow-delay=".75s"
                            style="visibility: visible; animation-delay: 0.75s; animation-name: fadeInLeft;">
                        <img src="{{ asset('frontend') }}/assets/img/section-img/about-2-2.jpg" alt=""
                            class="a3img-2 wow fadeInLeft" data-wow-delay=".25s"
                            style="visibility: visible; animation-delay: 0.25s; animation-name: fadeInLeft;">
                        <img src="{{ asset('frontend') }}/assets/img/section-img/about-2-2.jpg" alt=""
                            class="a3img-3 wow fadeInLeft" data-wow-delay=".25s"
                            style="visibility: visible; animation-delay: 0.25s; animation-name: fadeInLeft;">
                    </div>
                        ...
                        <div class="section-text">
                            <div class="section-titleV1">
                                <p class="wow fadeInUp" data-wow-delay=".15s"
                                    style="visibility: visible; animation-delay: 0.15s; animation-name: fadeInUp;">About
                                    us</p>
                                <h3 class="wow fadeInUp" data-wow-delay=".25s"
                                    style="visibility: visible; animation-delay: 0.25s; animation-name: fadeInUp;">
                                    Photography Is Great</h3>
                            </div>
                            <p class="wow fadeInUp" data-wow-delay=".35s"
                                style="visibility: visible; animation-delay: 0.35s; animation-name: fadeInUp;">Photography
                                is like a moment, an instant. You need a half-second to get the
                            ...
                            <ul>
                                <li class="wow fadeInUp" data-wow-delay=".45s"
                                    style="visibility: visible; animation-delay: 0.45s; animation-name: fadeInUp;">You're
                                    shooting, like, one frame every twenty minutes, so that's</li>
                                <li class="wow fadeInUp" data-wow-delay=".55s"
                                    style="visibility: visible; animation-delay: 0.55s; animation-name: fadeInUp;">Seconds
                                    of a film per day. Photography is a pursuit that allows</li>
                                <li class="wow fadeInUp" data-wow-delay=".65s"
                                    style="visibility: visible; animation-delay: 0.65s; animation-name: fadeInUp;">
                                    Hands-on with what you show people of either yourself or the</li>
                            </ul>
                            <p class="wow fadeInUp" data-wow-delay=".75s"
                                style="visibility: visible; animation-delay: 0.75s; animation-name: fadeInUp;">You do have
                                a modicum of creative freedom as an actor, but you're still very
                            ...
                            <a href="#" class="btn-style-1 wow fadeInUp" data-wow-delay=".85s"
                                style="visibility: visible; animation-delay: 0.85s; animation-name: fadeInUp;">Contact
                                Us</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- /About Area -->
    <!-- Our Portfolio -->
    <section class="portfolio18-area section-padding">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-titleV2alt">
                        <h3 class="wow fadeInUp" data-wow-delay=".2s"
                            style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Our Portfolio
                        </h3>
                        <p class="wow fadeInUp" data-wow-delay=".4s"
                            style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">Photography is a
                            demanding action sport. The light can change so quickly. I often find myself
                            sprinting so that I can catch the perfect light falling on a photogenic subject.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".2s"
                        style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-1.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-1.jpg">
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".4s"
                        style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-2.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-2.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".6s"
                        style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-3.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-3.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".8s"
                        style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-4.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-4.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".2s"
                        style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-5.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-5.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".4s"
                        style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-6.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-6.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".6s"
                        style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-7.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-7.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".8s"
                        style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-8.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-8.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".2s"
                        style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-9.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-9.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".4s"
                        style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-10.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-10.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".6s"
                        style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-11.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-11.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
                ...
                <div class="col-md-3 no-pad">
                    <div class="single18-portfolio wow fadeInUp" data-wow-delay=".8s"
                        style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                        <div class="sp-img">
                            <img src="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-12.jpg" alt="">
                        </div>
                        <div class="sp-hover">
                            <a data-fancybox="group-4" class="fancyGallery"
                                href="{{ asset('frontend') }}/assets/img/portfolio/portfolio18-12.jpg">
                                <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                            </a>
                            <h4>Portrait Rear</h4>
                            <p>Photography</p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-img about3-img">
                        <img src="{{ asset('frontend') }}/assets/img/section-img/about-3-2.jpg" alt=""
                            class="a3img-1">
                        <img src="{{ asset('frontend') }}/assets/img/section-img/about-3.png" alt=""
                            class="a3img-2 wow fadeInLeft" data-wow-delay=".4s">
                    </div>

                </div>
                <div class="col-md-6">
                    <div class="about-text about3-text">
                        <h3 class="wow fadeInUp" data-wow-delay=".2s">Photography is our passion.
                            Whenever we get time, We click.
                            Photography is a very important
                            part of our life.</h3>
                        <p class="wow fadeInUp" data-wow-delay=".4s">Photography is like a moment, an instant. You
                            need a half-second to get
                            photo. So it's good capture people when they are themselves.I became
                            passionate about nature filmmaking when I graduated from UCLA, and
                            of the things I always wanted to do was shoot really high.</p>
    ...
    <!-- Testimonial Area -->
    <section class="testimonial2-area section-padding bgDark">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-titleV1">
                        <p class="wow fadeInUp" data-wow-delay=".15s">Testimonials</p>
                        <h3 class="wow fadeInUp" data-wow-delay=".35s">clients feedbacks</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="chrisSingle-testimonial">
                                    <div class="tc-text">
                                        <p>Photography is a way of feeling, of touching, of loving. What you have caught on
                                            ...
                                            it remembers little things after have forgotten everything. Photography powerful
                                            mediu expression
                                            and communications, offers an infinite variety of perception, interpretation.
                                        </p>
                                    </div>
                                    <div class="tc-name">
                                        <h4>Syetrot Ruberti</h4>
                                        <p>CEO of Newrei</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="sync2" class="tc-avatar-carousel owl-carousel owl-theme wow fadeInUp"
                            ...
                            <div class="item">
                                <div id="chti-1" class="tc-avatar">
                                    <img src="{{ asset('frontend') }}/assets/img/avatar/t-avatar-1.jpg" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div id="chti-3" class="tc-avatar">
                                    <img src="{{ asset('frontend') }}/assets/img/avatar/t-avatar-2.jpg" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div id="chti-2" class="tc-avatar">
                                    <img src="{{ asset('frontend') }}/assets/img/avatar/t-avatar-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="gallery-carousel owl-carousel owl-theme wow fadeInUp" data-wow-delay=".35s">
                    <div class="item">
                        <div class="gc-single">
                            <img src="{{ asset('frontend') }}/assets/img/slider/gallery/gc-img-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="item">
                        <div class="gc-single">
                            <img src="{{ asset('frontend') }}/assets/img/slider/gallery/gc-img-2.jpg" alt="">
                        </div>
                    </div>
                    <div class="item">
                        <div class="gc-single">
                            <img src="{{ asset('frontend') }}/assets/img/slider/gallery/gc-img-3.jpg" alt="">
                        </div>
                    </div>
                    <div class="item">
                        <div class="gc-single">
