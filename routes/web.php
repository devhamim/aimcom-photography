...
Route::get('/our/portfolio', [FrontendController::class, 'our_videos'])->name('our.portfolio');
...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::resource('storiescategory', BlogCategoryController::class);
    Route::resource('storiessubcategory', BlogsubCategoryController::class);
    ...
    Route::get('/message/index', [HomeController::class, 'message_index'])->name('message.index');
    Route::get('/message/destroy/{id}', [HomeController::class, 'message_destroy'])->name('message.destroy');
});
